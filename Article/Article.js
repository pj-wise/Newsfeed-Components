const articleData = [
  ...
  {
    title: `Professional Software Development in 201`,
    date: `Nov 7th, 2017`,
    paragraph: `Hodor, hodor. Hodor. Hodor, hodor, hodor. Hodor hodor, hodor. Hodor hodor, hodor, hodor hodor. Hodor! Hodor hodor, hodor;
...
/* <div class="article" data-aos="fade-left" data-aos-duration="1000">
...
articleData.forEach(data => {
  articles.appendChild(createArticle(data.title, data.date, data.paragraph))
})
